"""time: working with timestamps, uuid: generate unique session tokens, base64: encode/decode data"""
...
# ===============================
# Initialize store & default user
# ===============================
_store = UserStore()
if not _store.exists("test"):
    _store.add_user("test", "123456")  # sample account for quick testing
...
def create_session(username: str) -> Tuple[str, bytes]:
    """Create new session: generate token and AES key."""

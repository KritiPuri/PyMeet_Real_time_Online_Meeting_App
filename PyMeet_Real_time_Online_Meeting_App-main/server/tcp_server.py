        ...
        while True:
            ...
            if t == "login":
                ...
                await send_msg(writer, {
                    "ok": True,
                    "type": "login_ok",
                    "username": username,   # add username for gateway to remember
                    "token": token,
            ...
            # ===== ROOMS =====
                ...
                # Send current user list to the person who just joined
                ...
                # Send participant_joined to other users in the room
                for u in rooms[r]:
